...
> **📚 SSRF 시리즈 (1/2)** — SSRF 방어의 일반 원칙과 “패치된 SSRF”의 우회를 다룬다. 후속편 [AI 실행 환경의 패키지·컨테이너 레지스트리 경계와 Egress 통제 구조]({{< relref "post/2026-07-27-ai-package-egress-boundary-architecture.md" >}})에서는 이 원칙이 AI 런타임의 패키지 프록시 경계로 확장되는 문제를 다룬다.
