...
image: "/images/pdf-previews/Security_Knowledge_to_System_Design_p1.webp"
...
- **Open (new tab):** [`/files/Security_Knowledge_to_System_Design.pdf`](/files/Security_Knowledge_to_System_Design.pdf)

<iframe
  id="pdfjs-security-knowledge-to-system-design-ko"
  src="/pdfjs/single.html?file=/files/Security_Knowledge_to_System_Design.pdf#page=1"
  width="100%"
  height="560"
...
<script>
  (function () {
    const iframe = document.getElementById("pdfjs-security-knowledge-to-system-design-ko");
    if (!iframe) return;
...
> PDF가 보이지 않으면 여기로 열어보세요: [`/files/Security_Knowledge_to_System_Design.pdf`](/files/Security_Knowledge_to_System_Design.pdf)
