...
description: "탐지 이후를 흡수하는 구조를 코드, 방법론, 거버넌스 관점에서 기록합니다."
---

이 블로그의 대표 서문은 [코드 이후에도, 구조는 남는다](/ko/post/2026-04-21-after-the-code-the-structure-remains/) 입니다. 이곳의 글들은 취약점을 더 많이 찾는 문제보다, 발견 이후를 조직이 어떻게 흡수하고 지속시키는지를 기술, 방법론, 거버넌스 층위에서 추적합니다.
